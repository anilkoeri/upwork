...
class AdminSettingController extends Controller
{
    ...
    public function __construct()
    {
        ...
        \View::share('page_title', 'Admin Setting');
    }
    /**
...
//        $this->authorize('create', Setting::class);
        $setting = new Setting();
        return view('admin.admin-setting.create',compact('setting'));
    }
...
//        $this->authorize('create', Setting::class);
        ...
        return redirect('admin/admin-setting')->with('success','Setting Created Successfully');
...
//        $this->authorize('view', Setting::class);
        ...
        return view('admin.admin-setting.show',compact('setting'));
    }
...
//        $this->authorize('update', Setting::class);
        ...
        return redirect('admin/admin-setting')->with('success','Successfully Updated');
    }
...
//        $this->authorize('destroy', Setting::class);
        ...
        return redirect('admin/admin-setting')->with('success','Successfully Deleted');
    }
    /**
...
//        $this->authorize('view', Setting::class);
        ...
        if($lists){
            foreach($lists as $r){
                ...
                $nestedData['action'] = \View::make('admin.admin-setting.action')->with('r',$r)->render();
